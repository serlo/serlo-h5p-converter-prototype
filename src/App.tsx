...
const ContentDump = (props: any) => {
  ...
  return (
    <div>
      <p>{content}</p>
      <button type="button" onClick={() => {console.log(contentService.editorContent); editor.current?.save(); setContent(contentService.editorContent);}}>Save</button>
    </div>
  );
};
  ...
  return (
    <div className="App">
      <H5PEditorUI
        ...
        onSaved = { (contentId: string, metadata: any) => {console.log(contentId);} }
